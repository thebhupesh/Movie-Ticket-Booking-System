...
export default class Upcoming extends Component {
    ...
    render() {
        ...
        return (
            <div id="upcoming" className="container mt-5">
                <div className="card bg-dark text-white" style={{textAlign: "center"}}>
                    <h5 className="card-body">Upcoming</h5>
                </div>
                <div className="row">
                    {this.state.movies ? this.state.movies.map((movie) => (this.today<new Date(movie.indate+" 00:00:00") ?
